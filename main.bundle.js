...
module.exports = "<ul>\n  <li><a routerLink=''>Home</a> </li>\n  <li><a routerLink=\"about/29\">About</a> </li>\n</ul>\n\n\n\n<router-outlet></router-outlet>\n"
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['Tste1', 'Teste2']);
        this.goal = this.goals.asObservable();
    }
    DataService.prototype.changeGo = function (goal) {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this._data.goal.subscribe(function (res) { return _this.goals = res; });
        this._data.changeGo(this.goals);
    };
    HomeComponent.prototype.addItem = function () {
        this.goals.push(this.goalTex);
        this.itemCount = this.goals.length;
        this.goalTex = '';
        this._data.changeGo(this.goals);
    };
